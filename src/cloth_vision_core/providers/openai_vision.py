...
Do not name the product and do not infer fabric or material composition. Never invent brand or
price. Color values must describe the garment. Enum values must use the supplied English values.
Keep tags short, lowercase, and stable."""
        ...
        *,
        ...
        if client is None:
            try:
                ...
                raise ProviderError("OpenAI vision support requires the 'openai' extra") from exc
